...
namespace ProjectManager.Test
{
    ...
    public class ProjectControllerTest
    {
        ...
        public void TestGetProjects_Success()
        {
            ...
            var result = controller.RetrieveProjects() as Models.JSendResponse;

            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Data, typeof(List<Models.Project>));
            Assert.AreEqual((result.Data as List<Models.Project>).Count, 2);
        }
        ...
        public void TestInsertProjects_Success()
        {
            ...
            var controller = new ProjectController(new BC.ProjectBC(context));
            var result = controller.InsertProjectDetails(testProject) as Models.JSendResponse;
        ...
        public void TestUpdateProjects_Success()
        {
            ...
            var controller = new ProjectController(new BC.ProjectBC(context));
            var result = controller.UpdateProjectDetails(testProject) as Models.JSendResponse;
        ...
        public void TestDeleteProjects_Success()
        {
            ...
            var result = controller.DeleteProjectDetails(testProject) as Models.JSendResponse;
            Assert.IsNotNull(result);
